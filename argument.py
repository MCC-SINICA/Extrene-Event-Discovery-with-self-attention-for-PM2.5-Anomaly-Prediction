...
def add_arguments(parser):
    ...
    parser.add_argument("--device",       type=int,                 help='use gpu number')
    ...
    parser.add_argument('--lr_step',      type=int,   default=0,    help='')
    ...
    parser.add_argument('--use_gamma',       action='store_true',      help='')
